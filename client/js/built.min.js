...
var lastUpdate = Date.now(), minInterval = 2, canHandleOrientation;

var cubeEnabled = true, compassEnabled = false;

$(document).ready(function() {
    var HOST = "192.168.0.106", socket = io.connect("http://" + HOST);
    var $cube = $(".cube"), $hostView = $(".host-specific-view"), $controllerView = $(".controller-specific-view"), $instance = $(".instance"), $cubeWrapper = $(".cube-wrapper"), $compassWrapper = $(".compass-wrapper"), $compassPointer = $(".compass-pointer"), $interval = $(".interval"), $debugAxisX = $('.debug-axis[data-axis="x"'), $debugAxisY = $('.debug-axis[data-axis="y"'), $debugAxisZ = $('.debug-axis[data-axis="z"');
    ...
    function setupHost() {
        ...
        function startMovingCube() {
            ...
            socket.on("controllerInstruction", function(orientation) {
                if (cubeEnabled) handleCube(orientation.gamma, -orientation.beta);
